...
processGoogleLiTag:function(li, doc, t) {
	...
	if (doc.evaluate(".//div[contains(@class, 'th')]", li, null, XPathResult.ANY_TYPE, null).iterateNext() != null) return false;
	...
	chrome.runtime.onMessage.addListener(function(request, sender, sendResponse) {
	    if (request.method == "updatePreview") {	
	    	...
	    	if (i > 0) {
	    		...
	    		var updateUrl = proto + "://update.searchpreview.de/update?" + request.sourceUrl.substring(i) + "&retpic=true";
