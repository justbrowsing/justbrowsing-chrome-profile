...
this.manifest = {
    ...
    "settings": [
        ...
        },
        {
            "tab": i18n.get("settings"),
            "group": i18n.get("Placeholder"),
            "name": "placeHolderminWidth",
            "type": "text",
            "label": i18n.get("placeHolderminWidth"),
        },
        {
            "tab": i18n.get("settings"),
            "group": i18n.get("Placeholder"),
            ...
            "type": "text",
            "label": i18n.get("placeHolderminHeight"),
        },
        ...
        {
            "tab": i18n.get("About"),
            "group": i18n.get("FlashFree"),
            "name": "FlashFree",
            "type": "description",
            "text": i18n.get("x-FlashFree")
        },
        {
            "tab": i18n.get("About"),
