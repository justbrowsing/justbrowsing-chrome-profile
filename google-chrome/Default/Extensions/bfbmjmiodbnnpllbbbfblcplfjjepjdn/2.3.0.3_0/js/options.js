...
for (var i = 0; i < nightDomainsBox.length; i++)
    ...
    localStorage["nightDomains"] = JSON.stringify(nightDomains);
}
...
function read_options(){
	...
	if(window.localStorage['nighttheme'] == 'true')$('nighttheme').checked = true;
	if(window.localStorage['nightonly'] == 'true'){$('nightonly').checked = true;$('nightDomainsBox').disabled = false;$('nightwebsiteurl').disabled = false;$('nightaddbutton').disabled = false;$('nightremovebutton').disabled = false;}
	...
	if(window.localStorage['nightenabletheme'] == 'true')$('nightenabletheme').checked = true;
...
var nightDomains = window.localStorage["nightDomains"];
...
$("tabnight").addEventListener('click', function() {ONworkaroundbugfromsafari();$('welcomeguide').src = "";});
