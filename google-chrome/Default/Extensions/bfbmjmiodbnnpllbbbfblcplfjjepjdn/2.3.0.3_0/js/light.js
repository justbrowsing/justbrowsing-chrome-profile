...
if(playerapi)$('player-api').style.zIndex = 'auto';
...
div = document.getElementsByTagName('div'); 
for(var i = 0; i < div.length; i++ ) 
{if(div[i].className == ('html5-video-controls')) {div[i].style.zIndex = 1001;div[i].style.visibility = 'visible';}}
...
if(appbarguidemenu){$('appbar-guide-menu').style.zIndex = 'auto';}
...
// if (y >= 1000){q[i].style.zIndex = 997;}
// }
...
if (window.location.href.match(/((http:\/\/(.*testyoutube\.com\/.*))|(https:\/\/(.*testyoutube\.com\/.*)))/i)){} // flash detection off for youtube.com
else {
// embed iframe
var iframe = document.querySelectorAll('iframe');
for(var i = 0; i < iframe.length; i++ ){
...
if((insideframe.substring(0, 17) == '//www.youtube.com') || (insideframe.substring(0, 26) == '//www.youtube-nocookie.com') || (insideframe.substring(0, 22) == 'http://www.youtube.com') || (insideframe.substring(0, 23) == 'https://www.youtube.com') || (insideframe.substring(0, 31) == 'http://www.youtube-nocookie.com') || (insideframe.substring(0, 32) == 'https://www.youtube-nocookie.com')
