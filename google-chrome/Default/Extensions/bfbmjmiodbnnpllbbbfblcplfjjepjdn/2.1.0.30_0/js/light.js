...
if(head == 'true'){
span = document.getElementsByTagName('button');  // new youtube watch7
for(var i = 0; i < span.length; i++ ) 
{if(span[i].className == ('yt-subscription-button yt-subscription-button-js-default yt-uix-button yt-uix-button-subscribe-branded yt-uix-tooltip') ) {span[i].style.zIndex = 1000;span[i].style.position = 'relative';}}

span = document.getElementsByTagName('span');  // new youtube watch7
for(var i = 0; i < span.length; i++ ) 
{if(span[i].className == ('video-thumb ux-thumb yt-thumb-square-48 ') ) {span[i].style.zIndex = 1000;span[i].style.position = 'relative';}}
...
if(watchdislike){$('watch-dislike').style.zIndex = 1000;$('watch-dislike').style.position = 'relative';} // new youtube watch7
...
if(playercontainer)$('player-container').style.zIndex = 'auto';

div = document.getElementsByTagName('div'); 
for(var i = 0; i < div.length; i++ )
{if(div[i].className == ('player-container')) {div[i].style.zIndex = 'auto';}}
...
if((insideframe.substring(0, 22) == 'http://www.youtube.com') || (insideframe.substring(0, 23) == 'https://www.youtube.com') || (insideframe.substring(0, 31) == 'http://www.youtube-nocookie.com') || (insideframe.substring(0, 32) == 'https://www.youtube-nocookie.com')
|| (insideframe.substring(0, 16) == 'http://vimeo.com') || (insideframe.substring(0, 17) == 'https://vimeo.com') || (insideframe.substring(0, 23) == 'http://player.vimeo.com') || (insideframe.substring(0, 24) == 'https://player.vimeo.com') || (insideframe.substring(0, 29) == 'https://secure-a.vimeocdn.com') 
...
|| (insideframe.substring(0, 26) == 'http://www.facebook.com/v/') || (insideframe.substring(0, 27) == 'https://www.facebook.com/v/') || (insideframe.substring(0, 26) == 'http://static.ak.fbcdn.net')  || (insideframe.substring(0, 27) == 'https://static.ak.fbcdn.net') // facebook embed video
|| (insideframe.substring(0, 25) == 'http://www.hulu.com/embed') || (insideframe.substring(0, 26) == 'https://www.hulu.com/embed')
...
|| (insideframe.substring(0, 32) == 'http://videohosting.sidereel.com') || (insideframe.substring(0, 33) == 'http4://videohosting.sidereel.com')
...
iframe[i].style.cssText = 'visibility:visible !important; position:relative !important; z-index:1000 !important;' + 'height:' + Math.round(spar) + 'px; width:' + Math.round(been) + 'px';
//iframe[i].style.cssText = 'visibility:visible !important; position:relative !important; z-index:1000 !important';
}
}
...
div = document.getElementsByTagName('article');for(var i = 0; i < div.length; i++ ){div[i].style.cssText = "-webkit-transform: none!important;";}
}
...
else if (window.location.href.match('http://espn.go.com')){
intelligentvideodetection();
}

// nfl.com, fixed show video
else if (window.location.href.match(/http:\/\/(.*nfl\.com\/.*|www\.nfl\.com\/.*\/.*)/i)){
intelligentvideodetection();
}
