...
return randomString;}};var ATX=ATX||{};ATX.dev=false;if(ATX.dev){ATX.log=function(text){console.log("ATX: "+text);}}else{ATX.log=function(text){return;}}
...
return localStorage['cuid'];};ATX.util.generateCuid=function(){var d=new Date(),z='00000000';var lo=Math.floor(Math.random()*(4294967295));var hi=Math.floor(d.getTime()/1000.0);lo=lo.toString(16);hi=hi.toString(16);lo=z.substring(0,8-lo.length)+lo;hi=z.substring(0,8-hi.length)+hi;return hi+lo;};