// (C) 2012 Prevoow UG & Co. KG, Edward Ackroyd, Paderborn, Germany 
...
getGPSub: function(href) {
    var site = this.getFullDomain(href);
    ...
    if (site.length == 0) return "a";
    
    if (this.TIMEZONE_OFFSET < 120) {
    	return site.charAt(0); 
    }
    else {
    	switch(site.charAt(0)) {
    		case 'a':
    		case 'b':
    			return "usab";
    		case 'c':
